      ...
      <table className="table">
        <thead> 
            ...
            <tr>
                ...
                <input style={{marginLeft:10}} value={user.password} onChange={(e) =>
                ...
                <BsPlusCircleFill onClick={createUser} style={{ color: 'green' }} className="text-success fs-1 text"/>
                </td>
            </tr>
        </thead>
        <tbody>
          {users.map((user: any) => (
            <tr key={user._id}>
              ...
              <td className="text-nowrap">
                ...
                <button className="btn btn-warning me-2" style={{marginLeft:10}}>
